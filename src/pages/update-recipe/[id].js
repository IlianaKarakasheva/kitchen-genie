    ...
    const onFormSubmit = async (event) =>{
        ...
        try {
            ...
            if (Object.keys(errors).length === 0){
                ...
                const updatedRecipe = {image: imageUrl,title: formData.title, time: Number(formData.time), ingredients: formData.ingredients, instructions: formData.instructions, userId: user.uid}
                const collectionRef= collection(firestore, "recipes")
                const newRecipeRef = await addDoc(collectionRef, updatedRecipe)
            ...
            <div className='newRecipe row align-items-center justify-content-center mt-4'>
                ...
                <form className='col-12 d-flex flex-row'>
                    <div className='image col-6 flex-column d-flex justify-content-center'>
                        ...
                        {
                            recipe.image && <img src={image? image:recipe.image} alt="preview image" className='selectedPhoto'/>
                        }
                    ...
                    <div className='col-6'>
                        <div className='title'>
                            ...
                            <input value={recipe.title} type="text" className='form-control' placeholder='Dish Title' name='title' onChange={onInputChange}  required />
                        ...
                        <div className='content'>
                            <div className='time'>
                                ...
                                <input defaultValue={recipe.time} type="number" className='form-control' placeholder='Time Needed' name='time' onChange={onInputChange} required />
                            ...
                            <div className='ingredients'>
                                ...
                                <Select value={preselectedOptions}
           options={options} isMulti onChange={onSelect}/>
                            ...
                            <div className='instructions'>
                                ...
                                <textarea defaultValue={recipe.instructions} rows="9" type="text" className='form-control' placeholder='Instructions' name='instructions' onChange={onInputChange} required />
                        ...
                        <button type="button" class="btn btn-sm btn-secondary me-2 mt-4 mb-3" onClick={onFormSubmit}>Submit Changes</button>
                    </div>
                </form>
            </div>
        </div>
